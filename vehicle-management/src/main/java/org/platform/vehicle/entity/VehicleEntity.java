...
public class VehicleEntity implements Serializable {
    ...
    private static final long serialVersionUID = 7239641042432821280L;
    ...
    public VehicleEntity(Integer customerId, Integer fleetId, Integer brandId, Integer specId,
            String licensePlate,
            String guaLicensePlate, String runRoute, String engineNumber, String vehicleIdNumber,
            String repeaterIdNumber,
            String receiverIdNumber, Date registDate, BigDecimal currentMileage,
            String createPerson,
            String updatePerson) {
        this();
        ...
        this.guaLicensePlate = guaLicensePlate;
        this.runRoute = runRoute;
        this.engineNumber = engineNumber;
        this.vehicleIdNumber = vehicleIdNumber;
        this.repeaterIdNumber = repeaterIdNumber;
