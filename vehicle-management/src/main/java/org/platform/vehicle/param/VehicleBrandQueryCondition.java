...
@Getter
@Setter
public class VehicleBrandQueryCondition extends PageParam {
	...
	public QueryWrapper<VehicleBrandEntity> wrapper() {
		QueryWrapper<VehicleBrandEntity> q = new QueryWrapper<VehicleBrandEntity>();
